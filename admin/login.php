...
$tab_erreur =
[
    'email' => 'Empty email, please specify your email',
    'password' => 'Password empty, please specify your password'
];
...
try
{
    ...
    if(array_key_exists('email',$_POST))
    {
        ...
        if(!filter_var($_POST['email'],FILTER_VALIDATE_EMAIL))
            $erreur.= '<br> You must enter a valid email !';
        ...
        if($erreur =='')
        {
            ...
            {
                $erreur.='<br>Connection impossible. 
...
{
    $erreur.='<br>A connection error has occurred :'.$e->getMessage();
}
